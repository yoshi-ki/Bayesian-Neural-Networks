...
import argparse
import matplotlib
from src.Bayes_By_Backprop.VGG11batchnorm import *
...
parser.add_argument('models_dir', type=str, nargs='?', action='store', default='VGG11_Batchnorm_models',
                    help='Where to save learnt weights and train vectors. Default: \'VGG11_Batchnorm_models\'.')
parser.add_argument('results_dir', type=str, nargs='?', action='store', default='VGG11_Batchnorm_results',
                    help='Where to save learnt training plots. Default: \'VGG11_Batchnorm_results\'.')
...
for i in range(epoch, nb_epochs):
    ...
    if i % 50 == 0:
      ...
      ax2.semilogy(range(0, i, nb_its_dev), 100 * err_dev[:i], 'b-')
