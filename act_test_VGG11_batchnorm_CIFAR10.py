...
parser.add_argument('--models_dir', type=str, nargs='?', action='store', default='VGG11_Batchnorm_models/theta_best.dat',
                    help='Where to save learnt weights and train vectors. Default: \'VGG11_Batchnorm_models/theta_best.dat\'.')
...
print("conv1", act_net.model.conv1.droprate_alpha_mean, act_net.model.conv1.droprate_beta_mean, net.model.conv1.droprate_relu_mean)
print("conv2", act_net.model.conv2.droprate_alpha_mean, act_net.model.conv2.droprate_beta_mean, net.model.conv2.droprate_relu_mean)
print("conv3", act_net.model.conv3.droprate_alpha_mean, act_net.model.conv3.droprate_beta_mean, net.model.conv3.droprate_relu_mean)
print("conv4", act_net.model.conv4.droprate_alpha_mean, act_net.model.conv4.droprate_beta_mean, net.model.conv4.droprate_relu_mean)
print("conv5", act_net.model.conv5.droprate_alpha_mean, act_net.model.conv5.droprate_beta_mean, net.model.conv5.droprate_relu_mean)
print("conv6", act_net.model.conv6.droprate_alpha_mean, act_net.model.conv6.droprate_beta_mean, net.model.conv6.droprate_relu_mean)
print("conv7", act_net.model.conv7.droprate_alpha_mean, act_net.model.conv7.droprate_beta_mean, net.model.conv7.droprate_relu_mean)
print("conv8", act_net.model.conv8.droprate_alpha_mean, act_net.model.conv8.droprate_beta_mean, net.model.conv8.droprate_relu_mean)
print("fc1", act_net.model.bfc1.droprate_alpha_mean, act_net.model.bfc1.droprate_beta_mean, net.model.bfc1.droprate_relu_mean)
print("fc2", act_net.model.bfc2.droprate_alpha_mean, act_net.model.bfc2.droprate_beta_mean, net.model.bfc2.droprate_relu_mean)
print("fc3", act_net.model.bfc3.droprate_alpha_mean, act_net.model.bfc3.droprate_beta_mean, net.model.bfc3.droprate_relu_mean)